...
public class StockDaoImpl implements StockDao {
	 ...
	 * 3-3.
	 * 입고 후 상품 재고 업데이트
	 * Parameter: Map (productId, quantity)
	 * Result: int
	 */
	@Override
	public int updateProductStockAfterPurchase(Map<String, Object> params) {
		return session.update("StockMapper.updateProductStockAfterPurchase", params);
	}
